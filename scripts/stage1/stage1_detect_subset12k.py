...
# random.seed(42)  # ทำให้สุ่มซ้ำได้ผลเดิม

# SRC_ROOT = Path(r"C:\Users\Chayanada\Desktop\shrimp_project\datasets\stage1_detect\merged")
# OUT_ROOT = Path(r"C:\Users\Chayanada\Desktop\shrimp_project\datasets\stage1_detect\subset_12k")

# SPLITS = ["train", "valid", "test"]
# IMG_EXTS = {".jpg", ".jpeg", ".png", ".bmp", ".webp"}

# # รวมประมาณ 12,000 รูป
# TARGETS = {
#     "train": 8400,
#     "valid": 2400,
#     "test": 1200,
...
#     "train: ../subset_12k/train/images\n"
#     "val: ../subset_12k/valid/images\n"
#     "test: ../subset_12k/test/images\n\n"
#     "nc: 1\n"
#     "names: ['shrimp']\n",
#     encoding="utf-8"
# )
